...
@SourceType(value = "EnterpriseDBARP", label = "EnterpriseDB",uiConfig = "enterprisedb-layout.json")
public class EnterpriseDBConf extends AbstractArpConf<EnterpriseDBConf> {
  private static final String ARP_FILENAME = "arp/implementation/enterprisedb-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.enterprisedb.EnterpriseDBDriver";
